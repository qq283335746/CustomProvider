...
namespace TygaSoft.CustomProvider
{
    internal static class SM
    {
        ...
        internal const string Auth_rule_names_cant_contain_char = "授权规则名称不能包含“{0}”字符。";
        internal const string Connection_name_not_specified = "数据库连接字符串 属性“connectionstringname”丢失或空。";
        ...
        internal const string Membership_Custom_Password_Validation_Failure = "自定义密码验证失败。";
        ...
        internal const string Membership_password_too_long = "密码太长：它必须是加密后台不超过128个的字符。";
        ...
        internal const string PageIndex_bad = "页索引必须是大于或等于零的整数。";
        internal const string PageIndex_PageSize_bad = "页索引和页大小的值最大不能超过System.Int32值。";
        internal const string PageSize_bad = "页大小必须是大于0的整数。";
        ...
        internal const string Password_does_not_match_regular_expression = "参数 '{0}'输入格式不正确。";
        internal const string Password_need_more_non_alpha_numeric_chars = "“{ 0 }”必须包含大于或等于“{ 1 }”个非字母数字的特殊字符";
        internal const string Password_too_short = "参数 '{0}'长度必须大于或等于 '{1}'。";
        ...
        internal const string Provider_application_name_too_long = "应用程序名称长度超过指定值，请检查！";
        ...
        internal const string Provider_role_already_exists = "角色 '{0}' 已存在.";
        internal const string Provider_role_not_found = "角色 '{0}' 不存在.";
        ...
        internal const string Provider_Invalid_Parameter = "参数：'{0}'值无效";
